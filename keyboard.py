...
off_link = types.InlineKeyboardButton(text="🌍 Официальный сайт", url="https://t.me/dark_revenge/")
vk_link = types.InlineKeyboardButton(text="⛓ Вконтакте", url="https://t.me/dark_revenge")
facebook_link = types.InlineKeyboardButton(text="⛓ Facebook", url="https://t.me/dark_revenge")
